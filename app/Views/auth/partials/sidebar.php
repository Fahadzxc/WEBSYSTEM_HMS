<nav class="sidebar">
	...
	<div class="sidebar-menu" id="sidebarMenu">
		...
		<?php else: ?>
			<!-- Dashboard -->
			<a href="http://localhost/WEBSYSTEM_HMS/admin/dashboard" class="menu-item dashboard">
			...
			<div class="menu-group" data-group="patients">
				...
				<div class="submenu">
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/patient-management/records">Patient Records</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/patient-management/add">Registration</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/patient-management/history">Medical History</a>
				</div>
			</div>
			...
			<div class="menu-group" data-group="scheduling">
				...
				<div class="submenu">
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/scheduling-management/doctor">Doctor Schedule</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/scheduling-management/nurse">Nurse Schedule</a>
				</div>
			</div>
			...
			<div class="menu-group" data-group="billing">
				...
				<div class="submenu">
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/billing-management/generate">Generate Bills</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/billing-management/payments">Payment Tracking</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/billing-management/insurance-claims">Insurance Claims</a>
				</div>
			</div>
			...
			<div class="menu-group" data-group="lab-management">
				...
				<div class="submenu">
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/lab-management/requests">Lab Requests</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/lab-management/results">Lab Results</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/lab-management/equipment">Equipment Status</a>
				</div>
			</div>
			...
			<div class="menu-group" data-group="pharmacy">
				...
				<div class="submenu">
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/pharmacy-management/inventory">Inventory Management</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/pharmacy-management/prescriptions">Prescription Orders</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/pharmacy-management/stock-alerts">Stock Alerts</a>
				</div>
			</div>
			...
			<div class="menu-group" data-group="reports">
				...
				<div class="submenu">
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/reports-management/performance">Performance Report</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/reports-management/financial">Financial Reports</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/reports-management/patient-analytics">Patient Analytics</a>
				</div>
			</div>

			<div class="menu-group" data-group="staff">
				<button class="group-toggle" type="button" onclick="window.location.href='http://localhost/WEBSYSTEM_HMS/admin/staff-management'"><span class="menu-icon">👥</span>Staff Management <span class="chev">›</span></button>
				<div class="submenu">
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/staff-management/employee-records">Employee Records</a>
					<a class="subitem" href="http://localhost/WEBSYSTEM_HMS/admin/staff-management/role-management">Role Management</a>
				</div>
			</div>

			<a href="http://localhost/WEBSYSTEM_HMS/admin/branch-management" class="menu-item"><span class="menu-icon">🏢</span>Branch Management</a>



			<a href="http://localhost/WEBSYSTEM_HMS/admin/system-settings" class="menu-item"><span class="menu-icon">⚙️</span>System Settings</a>
		<?php endif; ?>

		<a href="http://localhost/WEBSYSTEM_HMS/admin/logout" class="menu-item logout"><span class="menu-icon">🚪</span>Logout</a>
	</div>
				...
				if (btn.tagName === 'A') {
					...
					btn.addEventListener('click', (e)=>{
						...
						if (btn.textContent.includes('Patient Management')) {
							window.location.href = 'http://localhost/WEBSYSTEM_HMS/admin/patient-management';
						} else if (btn.textContent.includes('Scheduling')) {
							// For Scheduling group, go to Scheduling Management dashboard
							window.location.href = 'http://localhost/WEBSYSTEM_HMS/admin/scheduling-management';
						} else if (btn.textContent.includes('Billing & Payments')) {
							// For Billing & Payments group, go to main billing dashboard
							window.location.href = 'http://localhost/WEBSYSTEM_HMS/admin/billing-management';
							...
							window.location.href = 'http://localhost/WEBSYSTEM_HMS/admin/lab-management';
						} else if (btn.textContent.includes('Pharmacy Management')) {
							// For Pharmacy Management group, go to main pharmacy dashboard
							window.location.href = 'http://localhost/WEBSYSTEM_HMS/admin/pharmacy-management';
						} else if (btn.textContent.includes('Reports & Analytics')) {
							// For Reports & Analytics group, go to main reports dashboard
							window.location.href = 'http://localhost/WEBSYSTEM_HMS/admin/reports-management';
						} else {
